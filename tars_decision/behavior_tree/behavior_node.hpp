...
class BehaviorNode : public std::enable_shared_from_this<BehaviorNode>
{
  public:
     ...
     */
    BehaviorNode(std::string name, 
                 BehaviorType behavior_type, 
                 const Blackboard::SharedPtr &blackboard_ptr) 
                 : name_(name),
  ...
  protected:
    ...
    //! Blackboard
    Blackboard::SharedPtr blackboard_ptr_;
    //! Parent Node Pointer
...
{
  public:
    ActionNode(std::string name, const Blackboard::SharedPtr &blackboard_ptr) 
...
class PreconditionNode : public DecoratorNode
{
  public:
     ...
     */
    PreconditionNode(std::string name, 
                     const Blackboard::SharedPtr &blackboard_ptr,
...
bool PreconditionNode::Reevaluation()
{
    ...
    // Self Reevaluation
    if (abort_type_ == AbortType::SELF 
        || abort_type_ == AbortType::BOTH 
